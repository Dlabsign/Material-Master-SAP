*======================================================================*
* SAP BSP INPUT PROCESSING CONTROLLER: PURCHASING INFO RECORD APPROVAL
  ...
  CASE lv_action.
    ...
    WHEN 'GET_UPLOAD_DETAIL' OR 'GET_IR_DETAIL'.
      ...
      IF sy-subrc = 0.
        ...
        ls_ir_wrap-attachments = lt_att_json.
    ...
    WHEN 'QUICK_APPROVE' OR 'BULK_APPROVE'.
      ...
      LOOP AT lt_req_split INTO lv_req_item.
        ...
        " Call ME_DIRECT_INPUT_INFORECORD to create Info Record in SAP
        DATA: ls_eina TYPE eina,
              ls_eine TYPE eine,
              ls_first_itm TYPE zmdg_pir_itm.

        SELECT SINGLE * FROM zmdg_pir_itm
          INTO @ls_first_itm
          WHERE req_id = @lv_req_item.

        CLEAR: ls_eina, ls_eine.
        ls_eina-lifnr = ls_hdr_db-lifnr.
        ls_eina-matnr = ls_hdr_db-matnr.
        ls_eina-txz01 = ls_hdr_db-txz01.
        ls_eina-matkl = ls_hdr_db-matkl.
        ls_eina-idnlf = ls_hdr_db-idnlf.

        ls_eine-ekorg = ls_first_itm-ekorg.
        ls_eine-werks = ls_first_itm-werks.
        ls_eine-esokz = ls_first_itm-esokz.
        ls_eine-ekgrp = ls_first_itm-ekgrp.
        ls_eine-aplfz = ls_first_itm-aplfz.
        ls_eine-norbm = ls_first_itm-norbm.
        ls_eine-minbm = ls_first_itm-minbm.
        ls_eine-netpr = ls_first_itm-netpr.
        ls_eine-waers = ls_first_itm-waers.
        ls_eine-peinh = ls_first_itm-peinh.
        ls_eine-mwskz = ls_first_itm-mwskz.
        ...
        IF sy-subrc = 0 AND ls_eina-infnr IS NOT INITIAL.
          lv_gen_infnr = ls_eina-infnr.
